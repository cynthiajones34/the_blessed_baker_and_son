      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background:#3B1F0E;padding:32px 40px;text-align:center;border-radius:6px 6px 0 0;">
            <img src="https://theblessedbakerandson.com/logo.png" alt="The Blessed Baker and Son" width="160" style="display:block;margin:0 auto 12px;width:160px;height:auto;" />
            <p style="margin:0;font-family:Georgia,serif;font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:#C9AA72;">Est. 2005</p>
          </td>
        </tr>
...
exports.onNewOrder = functions.firestore
  ...
  .onCreate(async (snap, context) => {
    ...
    await sgMail.send({
      ...
      text: `New ${typeLabel} order from ${customerName}. Items: ${order.items || '—'}. Total: ${order.total || '—'}.`,
      html: adminHtml,
    });
    ...
    await sgMail.send({
      ...
      text: `Hi ${firstName}, we received your order request. We'll be in touch soon with a confirmation.`,
      html: customerHtml,
    });
...
exports.onOrderConfirmed = functions.firestore
  ...
  .onUpdate(async (change, context) => {
    ...
    await sgMail.send({
      ...
      text: `Hi ${firstName}, your order has been confirmed and is now in our baking queue. Thank you!`,
      html: confirmedHtml,
    });
